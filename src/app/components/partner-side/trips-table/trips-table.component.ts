  ...
  template: `
    <div class="trips-table-container">
      <ion-toolbar class="trips-toolbar">
        <ion-title class="text-lg font-semibold">{{ title || 'Trajets' }}</ion-title>
      ...
      <div class="trips-grid p-4">
          ...
          <ion-card *ngFor="let trip of trips" class="trip-card">
            ...
            <ion-card-content class="trip-details">
              <div class="detail-row">
                ...
                <span class="detail-value">{{ trip.availableSeats }}/{{ getBusCapacity(trip) }}</span>
              </div>
              <div class="detail-row">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">{{ trip.arrivalTime | date : 'HH:mm' }}</span>
              </div>
        ...
        <ng-template #noTrips>
          <div class="no-trips-message text-center py-8">
            <ion-icon name="airplane-outline" class="text-6xl text-gray-400 mb-2"></ion-icon>
            <p class="text-gray-500">{{ emptyMessage || 'Aucun trajet trouvé' }}</p>
          </div>
        </ng-template>
      </div>
    </div>
